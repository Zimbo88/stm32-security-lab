...
def test_bootloader_uart_transport_host_tests() -> None:
    assert_success(run_make("clean", "test"))


def test_bootloader_uart_transport_host_tests_with_sanitizers_when_supported() -> None:
